...
public class Movement {
    ...
    public void update(){
        entity.collision.collisionDetection();
        if(entity.collision.isCollisionX() == false || entity.collision.isCollisionY() == false){
            move();
        }
        onTopOf();
    }
