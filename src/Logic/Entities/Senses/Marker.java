...
public class Marker {
    ...
    public void leaveMarker(boolean isGuard) {
        ...
        entity.gamePanel.objectM.loopCleanMarker((int) entity.movement.getX(), (int) entity.movement.getY(), isGuard);
        ...
        if (entity.animation.getDirection() == "up") {
            foundMarker = entity.gamePanel.objectM.detectMarker((int) entity.movement.getX(), ((int) entity.movement.getY()) - 1, isGuard);
            ...
            foundMarker = entity.gamePanel.objectM.detectMarker(((int) entity.movement.getX()) - 1, (int) entity.movement.getY(), isGuard);
        ...
        if(foundMarker) {
            entity.vision.turnWhichWay(90);
        }

        int newMarkerIndex = selectMarkerType(isGuard);
        entity.gamePanel.objectM.addMarker((int) entity.movement.getX(), (int) entity.movement.getY(), newMarkerIndex);
    }
