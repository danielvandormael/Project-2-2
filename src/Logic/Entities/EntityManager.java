...
public class EntityManager {
    ...
    public void draw(Graphics2D g){
        ...
        for(int i = 0; i < guards.length; i++){
            ...
            g.drawImage(guards[i].getImage(), (int) guards[i].x*gamePanel.getTileSize(), (int) guards[i].y*gamePanel.getTileSize(), gamePanel.getTileSize()*2,  gamePanel.getTileSize()*2, null);
        }
        ...
        for(int i = 0; i < intruders.length; i++){
            ...
            g.drawImage(intruders[i].getImage(), (int) intruders[i].x*gamePanel.getTileSize(), (int) intruders[i].y*gamePanel.getTileSize(), gamePanel.getTileSize()*2,  gamePanel.getTileSize()*2, null);
        }
    }
}
