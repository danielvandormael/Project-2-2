...
public class Guard extends Entity {
    ...
    public BufferedImage[] getPlayerImage() {
        ...
        try {
            //left_stand
            temp[0] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/left_stand.png"));
            //left_walk
            temp[1] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/left_walk.png"));
            //right_stand
            temp[2] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/right_stand.png"));
            //right_walk
            temp[3] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/right_walk.png"));
            //up_stand
            temp[4] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/back_stand.png"));
            //up_walk1
            temp[5] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/back_walk1.png"));
            //up_walk2
            temp[6] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/back_walk2.png"));
            //down_stand
            temp[7] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/front_standing.png"));
            //down_walk1
            temp[8] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/front_walk1.png"));
            //down_walk2
            temp[9] = ImageIO.read(Guard.class.getResourceAsStream("/bit16/guard/front_walk2.png"));
